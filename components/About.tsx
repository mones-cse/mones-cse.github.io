const About = () => {
  return (
    <div className="text-white/50 font-light flex flex-col max-w-2xl mx-auto justify-center text-center gap-4 mb-10 pt-4 px-2.5" id="about">
      ...
      <p>
        ...
        financial institutions, developing solutions ranging from SaaS platforms
        to secure document management systems, analytical platforms with natural
        language querying (NLQ), and Web3 solutions leveraging IPFS.
      </p>
      <p>
        ...
        part of the Rockstart AI Accelerator in the Netherlands and the LongHash
        X Accelerator for Web3 innovations.
      </p>
      <p>
        With a Master’s and Bachelor’s in Computer Science and Engineering, I
        remain committed to learning and delivering impactful solutions tailored
        to real-world needs.
      </p>
